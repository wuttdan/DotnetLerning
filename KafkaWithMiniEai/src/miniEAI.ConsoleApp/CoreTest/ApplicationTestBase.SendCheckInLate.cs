...
public abstract partial class ApplicationTestBase 
{
    protected CommitSendCheckInLateRequestModel GetTempSendCheckInLateInstall()
    {
        return new()
        {
            ...
            MN_REMARKS = "test this is remark",
    ...
    protected CommitSendCheckInLateRequestModel GetTempSendCheckInLateMa()
    {
        return new()
        {
            Header = GetCommonRequestHeader(),
            MN_INTERNET_ID = "8850051224",
            MN_ORDER_NO = "SRT-008850051224",
            MN_APPOINTMENT_DATE = "2021-06-07",
            MN_SLOT = "19:00-22:00",
            MN_PACKAGE = "BROADBAND24 II Package 500/500 Mbps 599 THB 24 months",
            MN_PRODUCT_NAME = "FTTH/Playbox",
